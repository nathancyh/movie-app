module.exports = class MovieService {
    ...
    insert(data) {
        ...
        .insert([{api_id: data.id, title: data.title, genres: data.genres[0].name, overview: data.overview, popularity: data.popularity, poster_path: data.poster_path, release_date: data.release_date, runtime: data.runtime, vote_average: data.vote_average, vote_count: data.vote_count}])
        .onConflict('api_id')
        .merge()
        }
